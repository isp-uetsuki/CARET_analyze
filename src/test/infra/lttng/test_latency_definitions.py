...
class TestCallbackRecords:
    ...
    def test_inter_callback(
        ...
        data.add_merged_callback_timing_instance(
            callback_start, callback_end, callback_object, False)
        data.finalize()
    ...
    def test_intra_callback(
        ...
        data.add_merged_callback_timing_instance(
            callback_start, callback_end, callback_object, True)
        data.finalize()
...
class TestSubscriptionRecords:
    ...
    def test_single_records_without_tilde(
        ...
        data.add_merged_callback_timing_instance(1, 3, callback_object, False)
        data.finalize()
    ...
    def test_single_records_with_tilde(
        ...
        data.add_merged_callback_timing_instance(6, 8, callback_object, False)
        data.finalize()
...
class TestNodeRecords:
    ...
    def test_callback_chain(
        ...
        data.add_dispatch_subscription_callback_instance(
            0, callback_object, message, source_timestamp, message_timestamp)
        data.add_merged_callback_timing_instance(1, 2, callback_object, False)
        data.add_rclcpp_publish_instance(tid, 4, pub_handle, 5, 6)
        data.add_merged_callback_timing_instance(3, 5, callback_object_, False)
        data.finalize()
    ...
    def test_use_latest_message(
        ...
        # pid, tid = 6, 7
        tid = 7
        callback_end_timestamp = 4
        data.add_dispatch_subscription_callback_instance(
            0, callback_object, message, source_timestamp, message_timestamp)
        data.add_merged_callback_timing_instance(1, callback_end_timestamp, callback_object, False)
        pub_handle = 9
...
class TestCommunicationRecords:
    ...
    def test_inter_proc(
        ...
        data.add_merged_callback_timing_instance(16, 17, callback_obj, False)
        data.finalize()
    ...
    def test_inter_proc_with_message_drop(
        ...
        data.add_merged_callback_timing_instance(22, 23, callback_obj, False)
        data.finalize()
    ...
    def test_intra_proc(
        ...
        data.add_merged_callback_timing_instance(6, 7, callback_obj, True)
        data.finalize()
...
class TestTimerRecords:
    ...
    def test_timer(
        ...
        data.add_merged_callback_timing_instance(7, 8, callback_obj, False)
        data.finalize()
...
class TestVarPassRecords:
    ...
    def test_var_pass(
        ...
        data = Ros2DataModel()
        data.add_merged_callback_timing_instance(7, 8, callback_obj, False)
        data.add_merged_callback_timing_instance(9, 10, callback_obj_, False)
        data.finalize()
